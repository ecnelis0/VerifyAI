...
Step:3 Edit the codes by Visual Stdio Code
...
How to run:
Step1: Create your own Deepseek account and API key, https://platform.deepseek.com/

Step2: Create your own OpenAI accont and API key, https://platform.openai.com/

Step3: Copy your own API key to DEEPSEEK_KEY and OPENAI_KEY in file server.js

Step4: Run the command "node server.js"

Step5: Open the verfyai.html by browser
