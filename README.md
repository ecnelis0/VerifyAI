...
Step1: node install express
       node install cors

Step2: Copy the API key to the variables $DEEPSEEK_KEY and $OPENAI_KEY in file server.js

Step3: Run the command "node server.js"

Step4: Open the verfyai.html by browser
